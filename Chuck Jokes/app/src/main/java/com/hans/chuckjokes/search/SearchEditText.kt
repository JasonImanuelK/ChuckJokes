...
class SearchEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun setButtonDrawables(
        startOfTheText: Drawable? = null, topOfTheText: Drawable? = null, endOfTheText: Drawable? = null, bottomOfTheText: Drawable? = null
    ){
